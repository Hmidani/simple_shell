...
/**
 * _verifypath - a function that check if the path has a :
 * at the begining or if exist ::
...
/**
 *_getpath - a function that get the string in PATH env
 * @m: the string input.
...
/**
 * checkbin - a function that checks if arg[0] has /bin/
 * @b: the first string input.
 * @m: the second string input.
