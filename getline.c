#include "shell.h"
/**
 * salida3 - function for normal out
 * @m: the string input.
 * @e: the integer input.
 */
...
/**
 * salida2 - function to out with double Ctrl+D
 *@m: the string input.
 *@e: the integer input.
 *@line: the string input2.
 */
...
/**
 * salida1 - function for normal out
 * @m: the string input
 * @e: the integer input.
 */
 ...
 * @a: the integer input
 * @e: the string input
 * @m: the integer input 2.
 * @av: the string input2.
 * Return: an string value.
 */
