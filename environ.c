#include "shell.h"
/**
 * _isenv - a function that finds if the  line input is env
 * @p: the first string value.
 * @myenv: the second string value.
...
/**
 * create_env - a function taht create a copy of the environmental variables
...
/**
 * _env - function that to print the environment variables
